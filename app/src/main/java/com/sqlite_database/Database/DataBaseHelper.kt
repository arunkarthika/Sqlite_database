package com.sqlite_database.Database
...
class DataBaseHelper(context: Context) : SQLiteOpenHelper(context, DATABASE_NAME, null, DATABASE_VERSION) {
    ...
    fun getAllUser(): ArrayList<User> {
        ...
        val columns = arrayOf(COLUMN_USER_ID, COLUMN_USER_EMAIL, COLUMN_USER_NAME, COLUMN_USER_PASSWORD, COLUMN_PURPOSE)
        ...
        if (cursor.moveToFirst()) {
            do {
                val user = User(
                    ...
                    purpose = cursor.getString(cursor.getColumnIndex(COLUMN_PURPOSE))
                )
    ...
    fun addUser(user: User) {
        ...
        values.put(COLUMN_PURPOSE,user.purpose)
